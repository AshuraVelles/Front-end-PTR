        ...
        <div className="item-details">
          ...
          <div className="item-info">
            ...
            <div className="item-location">
              <span><strong>Latitude:</strong> {lostItem.localizacao_perdido.latitude}</span>
              <span><strong>Longitude:</strong> {lostItem.localizacao_perdido.longitude}</span>
            </div>
      ...
      <div className="container">
        ...
        <div className="item-details">
          ...
          <div className="item-info">
            ...
            <div className="item-location">
              <span><strong>Latitude:</strong> {foundItem.localizacao_achado.latitude}</span>
              <span><strong>Longitude:</strong> {foundItem.localizacao_achado.longitude}</span>
            </div>
